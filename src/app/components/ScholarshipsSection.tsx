...
export function ScholarshipsSection() {
 ...
 ريتال هو الذراع الأكاديمي لشركة نوباتيا، المختص في تقديم الخدمات التعليمية والاستشارات الأكاديمية منذ عام 2019          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          ...
          >
            ...
            <div className="text-gray-600">منحة المقدمة</div>
          </motion.div>
